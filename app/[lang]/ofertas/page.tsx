      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-emerald-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Suscríbete a nuestro newsletter y sé el primero en conocer las mejores ofertas y lanzamientos exclusivos.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            <input
              placeholder="tu@email.com"
              className="flex h-12 w-full rounded-md border border-white/20 bg-white/10 backdrop-blur-sm px-4 py-2 text-white placeholder:text-blue-200 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent"
            />
            <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-300 bg-white text-blue-600 hover:bg-blue-50 h-12 px-6">
              Suscribirse
            </button>
          </div>
        </div>
